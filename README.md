...
另外，相比原插件，我额外添加了如下满足自身需要的功能：

- **在作品预览窗口显示元数据信息。** 目前会在作品预览窗口的顶部展示“收藏数”和“AI 生成”信息。
- **支持隐藏当前页面已收藏作品。** 点击右下角的“过滤收藏”按钮，可以隐藏当前页面里已标注爱心的作品，提升发现更多优质作品的效率。
...
- [ ] 作品排序功能
  ...
  - [x] Feature：对发布时间超过 **1 小时**的作品，缓存作品详细信息。缓存过期时间为 **2 小时**。
  - [ ] Feature：支持收藏 / 取消收藏作品
